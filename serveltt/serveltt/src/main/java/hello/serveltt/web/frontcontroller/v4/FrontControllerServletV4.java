package hello.serveltt.web.frontcontroller.v4;
...
import hello.serveltt.web.frontcontroller.v4.controller.MemberFormControllerV4;
import hello.serveltt.web.frontcontroller.v4.controller.MemberListControllerV4;
import hello.serveltt.web.frontcontroller.v4.controller.MemberSaveControllerV4;
...
public class FrontControllerServletV4 extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //paraMap
        Map<String, String> paraMap = creatParamMap(request);
